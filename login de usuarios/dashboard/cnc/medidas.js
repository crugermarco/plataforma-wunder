const sheetConnections = {
  medidas: {
    scriptUrl: 'https://script.google.com/macros/s/AKfycbzH7hJ_4q3j1lZvk12HWtm1ltiPjmuDR2aKHKwu6HdbATEtZiqdFiD5zTTI61St7KWvxw/exec',
...
const measurementStructure = {
  ...
  set2: [
    ...
    { key: 'alitaMorada2', label: 'ALITA MORADA', required: false, isInfo: false }
  ...
  set3: [
    ...
    { key: 'alitaMorada3', label: 'ALITA MORADA', required: false, isInfo: false }
  ...
  set4: [
    ...
    { key: 'alitaMorada4', label: 'ALITA MORADA', required: false, isInfo: false }
    ...
    const content = `
        <div class="form-group">
            ...
            <div class="reference-summary">
                ...
                <div class="reference-item">
                    <strong>ALITA MORADA:</strong> <span class="reference-value">${refValues.alitaMorada1 || 'N/A'}</span>
                </div>
            </div>
...
function showMeasurementForm() {
    ...
    } else if (field.label === 'ALITA MORADA') {
        imageUrl = currentRow.referenceImages.alitaMoradaImagen || '';
    }
    ...
    try {
        const values = rows.map(row => {
            return [
                ...
                row.referenceValues.alitaMorada1 || 'N/A',
                ...
                row.measurements.alitaMorada2 || 'N/A',
                ...
                row.measurements.alitaMorada3 || 'N/A',
                ...
                row.measurements.alitaMorada4 || 'N/A',
                row.notes || ''
            ];
        });
